...
この方法ならばハイレゾにも対応している[^1]し、バグまみれで重いデスクトップ版よりはAndroid版の方が使いやすい。
...
| FLAC保存 | ハイレゾに対応。オフラインでも聞ける。 | 規約的にグレーゾーンっぽい。PCの容量圧迫。 |
| Androidエミュレータ | ハイレゾに対応。ステーションなどの機能も使える。 | エミュレータの安全性は不明。PCの性能的に厳しい場合あり。アクセシビリティに難あり。 |

<br>

**戯言が再開される。ここでブラウザバック推奨。**

<br>

まず、人間の可聴範囲は広くても20~20kHzと言われているらしい[^2]。（私も19~20kHzあたりから聞こえなくなってくる。）
それでも尚ハイレゾにこだわる理由はあるのだろうか。
