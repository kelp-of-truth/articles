...
Web版よりも音質はいいがハイレゾには対応していないと思われる。 ただ、バグまみれで重いデスクトップ版よりはAndroid版の方が使いやすい。
...
|   | メリット | デメリット  |
|---|---|---|
| **Web版** | 簡単。ステーションなどの機能も使える。 | ハイレゾ、ロスレスに対応していない。曲のダウンロードができない。 |
| **FLAC保存** | ハイレゾに対応。オフラインでも聴ける。 | 利用規約的にほぼ黒。PCの容量圧迫。 |
| **Androidエミュレータ** | 音質はそこそこ。ステーションなどの機能も使える。オフラインでも聴ける | エミュレータの安全性は不明。PCの性能的に厳しい場合あり。アクセシビリティに難あり。 |

## 余談
人間の可聴範囲は広くても20\~20kHzと言われている[^1]。（私も19\~20kHzあたりを超えると聞こえなくなってくる。）
ハイレゾで96kHz出すことにこだわるのはロマンでしかないように思える。しかし、聞こえなくても効果はある[^1]らしいので全く無意味って訳でもなさそう。
...
[^1]: [高音聞こえないオヤジにハイレゾ音源の意味はある？](https://pc.watch.impress.co.jp/docs/news/1083636.html)
